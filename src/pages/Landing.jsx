      ...
      <div className="container">
        <div className="head-box">
          <h1 className="heading">
            ...
            <br />
            <span className="heading-thin">təlim proqramına qəbul başladı</span>
          </h1>
          <div className="text-area">
            <p className="text">
              Yerli animatorların kvalifikasiyasının artırılması məqsədilə
              “Animator’s Accelerator” təlim proqramının qəbuluna start verilib.
              Altı aylıq təlim proqramında iştirakdan sonra animatorlar
              beynəlxalq layihələrə cəlb ediləcək.
            </p>
            <br />
            <p className="text">
            ...
            <p className="text">
              ...
              edilmiş işlərini “Netflix”dən tutmuş “Apple TV”yə qədər bütün əsas
              beynəlxalq yayım platformalarında görmək olar və həmişə bütün
              dünya tamaşaçıları tərəfindən hörmətlə qarşılanıb.
            </p>
            <br />
